...
/**
 * An ObjectNode abstract implementation.
 * 
 * @author Andreou Dimitris, email: jim.andreou (at) gmail (dot) com
 */
abstract class ObjectNodeImpl
        extends RdfNodeImpl implements ObjectNode {
    private InternalType internalType = InternalType.UNKNOWN;
    
    ObjectNodeImpl(ModelImpl owner) {
        super(owner);
    }
    ...
    final void resetType() {
        RdfType oldType = type();
        this.internalType = TypeInference.defaultTypeFor(this);
        owner.handleTypeChange(TypeInference.initialChange(this, oldType, type()));
    }
    ...
    public Triples subjectTriples() {
        return owner().triples().s(this).fetch();
    }
