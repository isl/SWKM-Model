 ...
 * @author egiannak
 */
public class TestImporterSaveSchemaClassProperties extends TestCase {
        private final String name;
        private final Representation repr;
        String[][] paths = {
            {"http://ngtest3.org#", "test/resources/TestClassAndProperties.trig"}
        };
        protected final Jdbc jdbc;
        private final Database db = Database.db2;
        public TestImporterSaveSchemaClassProperties(String testName, Representation repr,
            String name) {
        super(testName);
        this.repr = repr;
        this.name = name;
    ...
    public static TestSuite suite() {
        ...
        for (Representation r : Arrays.asList(Representation.HYBRID)) {
            suite.addTest(new TestImporterSaveSchemaClassProperties("test", r, "test schema"));
        }
        return suite;
    }
